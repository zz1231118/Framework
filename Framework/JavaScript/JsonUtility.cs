...
namespace Framework.JavaScript
{
    ...
    public static class JsonUtility
    {
        ...
        /// </summary>
        /// <exception cref="System.ArgumentNullException"></exception>
        internal static string Transferred(string src)
        {
            if (src == null)
        ...
        /// <returns></returns>
        public static bool IsBsonRecommend(Json json)
        {
            if (json == null)
            ...
            if (ja != null)
                return ja.Any(p => IsBsonRecommend(p));

            var jo = json as JsonObject;
            if (jo != null)
                return jo.Values.Any(p => IsBsonRecommend(p));
